...
#' @param data data stored as a dataframe with columns as variables and rows as cases and controls in case control study.
...
response_vs_exposure <- function(data, exposure="phys",response="case",in_out, w){
